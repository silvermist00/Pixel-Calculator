...
Perfeita pra quem gosta de projetos **cute + retro**.

## Funcionalidades

- Design totalmente pixel art
- Tema rosa vibrante
- Operações básicas: `+ - × ÷`
- Porcentagem (`%`)
- Troca de sinal (`+/-`)
...
- **HTML5**
- **CSS3** (com variáveis CSS e pixel art)
- **JavaScript** (Vanilla)
...
1. Clone o repositório:
   ```bash
   git clone https://github.com/silvermist00/Pixel-Calculator.git
